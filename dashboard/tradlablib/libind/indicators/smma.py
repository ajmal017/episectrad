...
class SmoothedMovingAverage(object):
    ...
    def trigger(self):
        ...
        res = peakdetect(y_axis=self.smma, lookahead=5)
        maxpeaks = res[0]
        minpeaks = res[1]
    ...
    def train(self):
        ...
        params1 = prepare_params_for_smma()
        ...
        psetb = pret.loc[imax]
        return psetb, pret, signalsmmap[imax]
